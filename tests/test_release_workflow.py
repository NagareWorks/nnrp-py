...
def test_release_workflow_pins_preview4_rust_native_artifacts() -> None:
    ...
    assert "default: 1.0.0-preview.4.20" in workflow
    assert "vars.NNRP_RS_NATIVE_VERSION || '1.0.0-preview.4.20'" in workflow
...
def test_release_workflow_rejects_non_preview4_native_artifact_shape() -> None:
    ...
    assert "--require-abi-version 4.3.0" in workflow
