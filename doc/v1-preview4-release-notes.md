...
- Python `1.0.0rc4.post6` consumes Rust `1.0.0-preview.4.10` and exposes the frozen provider cost, preference,
...
- Python `1.0.0rc4.post6` pins Rust `1.0.0-preview.4.10` and requires ABI `3.0.x`.
