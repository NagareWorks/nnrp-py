...
- [x] Pin reviewed Rust artifact `1.0.0-preview.4.22`, containing the complete route/security, shutdown, submit, runtime-event, and frozen role-contract ABI.
...
- [x] Require Rust ABI `4.4.0` in the release workflow.
