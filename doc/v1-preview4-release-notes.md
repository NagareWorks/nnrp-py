...
- Python `1.0.0rc4.post5` consumes Rust `1.0.0-preview.4.8` and exposes the frozen provider cost, preference,
...
- Python `1.0.0rc4.post5` pins Rust `1.0.0-preview.4.8` and requires ABI `3.0.x`.
