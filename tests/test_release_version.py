...
def test_current_release_version_tracks_preview4() -> None:
    ...
    assert release_version == "1.0.0rc4.post16"
    assert resolve_version.build_tag_name(release_version) == "v1.0.0-preview.4.post16"
...
def test_is_prerelease_distinguishes_preview_and_stable_versions() -> None:
    assert resolve_version.is_prerelease("1.0.0rc4.post16") is True
