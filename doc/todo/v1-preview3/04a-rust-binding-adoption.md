...
- [ ] Define the packaged native artifact layout for Windows, macOS, Linux, Android, and iOS.
- [ ] Add a platform and architecture resolver for x86, x86_64, arm, and arm64 variants.
- [ ] Load the native artifact through one internal backend module before exposing any host-facing API.
...
- [ ] Add loader and probe tests for every supported platform tag using fake or fixture native artifacts where real artifacts are unavailable.
