...
- [x] Pin Rust artifact `1.0.0-preview.4.26` and ABI `4.4.0` used by Python.
...
- [x] Expose every Python projection target frozen in `nnrp-doc`, including exact option shapes, role methods, the three-field terminal result, and the closed runtime/lifecycle event union enforced by CI.
