...
def test_release_workflow_pins_preview4_rust_native_artifacts() -> None:
    ...
    assert "default: 1.0.0-preview.4.26" in workflow
    assert "vars.NNRP_RS_NATIVE_VERSION || '1.0.0-preview.4.26'" in workflow
...
def test_release_workflow_downloads_all_preview4_native_transport_artifacts() -> None:
    ...
    assert 'NNRP_RS_RELEASE_RUN_ID: "32896006962"' in workflow
    assert "NNRP_RS_SOURCE_COMMIT: d45a17238ea9f8dba1bfdd8439416bb97c53180e" in workflow
...
def test_release_workflow_rejects_reused_identity_and_records_a_bom() -> None:
    ...
    assert "NNRP_CONFORMANCE_SOURCE_COMMIT: 054bcbe6e58c42aec896a9618777a37727023797" in workflow
    assert "NNRP_DOC_SOURCE_COMMIT: e568de05f0db1bfc914685dc5024722dc0f6f837" in workflow
